...
def obtener_nivel(puntos):
    """
    Clasifica al estudiante según la escala AKS-30.
    """
...
st.write(
    ...
    "mediante una prueba de 15 preguntas y utiliza la "
    "escala AKS-30 para determinar su nivel."
)
...
if enviar:
    ...
    if nombre.strip() == "":
        ...
        nivel, descripcion, conclusion = obtener_nivel(
            puntos
        )
        ...
        st.write(
            ...
            f"**{puntos} de 30 puntos**, equivalentes "
            f"al **{porcentaje:.1f}%** del puntaje máximo. "
            f"De acuerdo con la escala AKS-30, alcanzó "
        ...
        if conclusion == "SABE ALGORITMIA":
            ...
            st.write(
                "El resultado indica que el estudiante "
                "presenta un nivel de conocimiento "
                "suficiente en algoritmia."
            )
            ...
            st.write(
                "El resultado indica que el estudiante "
                "aún presenta dificultades en los "
                "fundamentos evaluados de algoritmia."
            )